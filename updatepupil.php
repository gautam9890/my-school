...
<body>
    ...
    <h2>Update Pupil Details</h2>

    <form method="post" action="updatepupil.php">
        <label for="pid">Enter Pupil ID:</label>
        <input type="text" name="pid"><br>

        <label for="name">Enter Pupil Name:</label>
        <input type="text" name="name"><br>

        <label for="dob">Enter Pupil DOB:</label>
        <input type="text" name="dob"><br>

        <label for="email">Enter Pupil Email:</label>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE pupil SET name='$name', dob='$dob', email='$email' WHERE pid=$pid";
