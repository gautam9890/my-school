...
<script>
    function validateform() {
        let a = document.forms["myform"]["pupilid"].value;
...
<body>
    ...
    <form method="post" action="addpupil.php" onsubmit="return validateform()">
        <label for="pid">Pupil ID:</label>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO pupil (pid, name, dob, email) VALUES ('$pid', '$name', '$dob', '$email')";

        if ($link->query($sql) === TRUE) {
            echo "Pupil added successfully";
        } else {
            echo "Error adding Pupil: " . $link->error;
        }
